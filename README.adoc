...
:toc: macro
:sourcedir: src/main/java/de/melsicon/example/validation
...
----
include::{sourcedir}/self_validating/SelfValidating.java[lines="10,12..13,15..20,22..27"]
----
...
[source,java,linenums]
----
include::{sourcedir}/validated/Person.java[lines=24..-1]
----
...
could use a http://immutables.github.io/immutable.html#strict-builder[strict builder].

[source,java,linenums]
----
include::{sourcedir}/immutables/Person.java[lines=12..-1]
----
